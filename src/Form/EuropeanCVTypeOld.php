...
class EuropeanCVTypeOld extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $now = new \DateTime();
        $builder->add('photo', JQueryFileUploadType::class, ['required' => false, 'label' => 'Fotografia', 'upload_route' => $options['photo_upload_route']])->add('name', null, ['label' => 'Titul, meno a priezvisko', 'attr' => ['placeholder' => 'Ing. Pavol Vzor']])->add('address', null, ['label' => 'Adresa', 'attr' => ['placeholder' => 'Vzorová 3, 841 01 Bratislava IV, Slovenská republika']])->add('email', null, ['label' => 'E-mail', 'attr' => ['placeholder' => 'vzor@vzor.sk']])->add('personalWebsite', null, ['label' => 'Osobná webová stránka', 'required' => false, 'default_protocol' => null, 'attr' => ['placeholder' => 'www.facebook.com/pali.vzor.10']])->add('nationality', null, ['label' => 'Štátna príslušnosť', 'attr' => ['placeholder' => 'Slovensko']])->add('dateOfBirth', null, ['widget' => 'single_text', 'label' => 'Dátum narodenia', 'attr' => ['placeholder' => 'Prosím, vyplňte', 'data-max-date' => $now->format('Y-m-d')]])->add('sex', ChoiceType::class, ['label' => 'Pohlavie', 'required' => $options['sex_required'], 'placeholder' => 'Prosím, vyberte možnosť', 'choices'  => array_flip(EuropeanCV::SEX_LIST)])->add('phones', CollectionType::class, ['entry_type' => EuropeanCVPhoneType::class, 'entry_options' => ['label' => false], 'by_reference' => false, 'label' => false, 'prototype' => true, 'allow_add' => true, 'allow_delete' => true, 'delete_empty' => true, 'attr' => [
        ...
        ]])->add('jobInterest', null, ['label' => 'Zamestnanie, o ktoré sa uchádzate', 'attr' => ['placeholder' => 'Prosím, vyplňte']])->add('languageMother', Select2Type::class, ['label' => 'Materinský jazyk', 'placeholder' => 'Prosím, vyberte možnosť', 'required' => false, 'choices'  => array_flip($this->europeanCvListing->getLanguageList()), 'preferred_choices'  => fn($value, $key) => in_array($value, ['sk'])])->add('skillCommunication', null, ['label' => 'Komunikačné zručnosti', 'attr' => ['placeholder' => 'Napr. poskytovanie spätnej väzby deťom počas futbalových tréningov.']])->add('skillManagement', null, ['label' => 'Organizačné a riadiace zručnosti', 'attr' => ['placeholder' => 'Napr. vedenie a motivovanie tímu desiatich ľudí.']])->add('skillJob', null, ['label' => 'Pracovné zručnosti', 'attr' => ['placeholder' => 'Napr. dobré ovládanie postupov kontroly kvality (zodpovednosť za audit kvality). ']])->add('skillOther', null, ['label' => 'Ďalšie zručnosti', 'attr' => ['placeholder' => 'Napr. certifikát v poskytovaní prvej pomoci, herecké aktivity - dobrovoľnícke divadlo.']])->add('skillDigitalInformationProcessing', Select2Type::class, ['label' => 'Spracovanie informácií', 'required' => false, 'placeholder' => 'Prosím, vyberte možnosť', 'choices_description_callback' => $this->getDescriptionFromSkillDigitalLevelOption(...), 'choices'  => array_flip(EuropeanCV::DIGITAL_SKILL_LEVEL_LIST)])->add('skillDigitalCommunication', Select2Type::class, ['label' => 'Komunikácia', 'required' => false, 'placeholder' => 'Prosím, vyberte možnosť', 'choices_description_callback' => $this->getDescriptionFromSkillDigitalLevelOption(...), 'choices'  => array_flip(EuropeanCV::DIGITAL_SKILL_LEVEL_LIST)])->add('skillDigitalContentCreation', Select2Type::class, ['label' => 'Vytváranie obsahu', 'required' => false, 'placeholder' => 'Prosím, vyberte možnosť', 'choices_description_callback' => $this->getDescriptionFromSkillDigitalLevelOption(...), 'choices'  => array_flip(EuropeanCV::DIGITAL_SKILL_LEVEL_LIST)])->add('skillDigitalSecurity', Select2Type::class, ['label' => 'Bezpečnosť', 'required' => false, 'placeholder' => 'Prosím, vyberte možnosť', 'choices_description_callback' => $this->getDescriptionFromSkillDigitalLevelOption(...), 'choices'  => array_flip(EuropeanCV::DIGITAL_SKILL_LEVEL_LIST)])->add('skillDigitalTroubleshooting', Select2Type::class, ['label' => 'Riešenie problémov', 'required' => false, 'placeholder' => 'Prosím, vyberte možnosť', 'choices_description_callback' => $this->getDescriptionFromSkillDigitalLevelOption(...), 'choices'  => array_flip(EuropeanCV::DIGITAL_SKILL_LEVEL_LIST)])->add('skillDigitalCertificate', null, ['label' => 'Názov certifikátu', 'attr' => ['placeholder' => 'Balík MS Office - samostatný používateľ']])->add('skillDigitalOther', null, ['label' => 'Ďalšie digitálne zručnosti', 'attr' => ['placeholder' => 'Napr. ovládanie softvéru na úpravu fotografií.']])->add('drivingLicenseOwner', ChoiceType::class, ['required' => false, 'label' => 'Vodičský preukaz', 'placeholder' => false, 'expanded' => true, 'multiple' => false, 'choices' => ['Nemám vodičský preukaz' => false, 'Mám vodičský preukaz' => true], 'choice_attr' => fn($choiceValue, $key, $value) => ['data-trexima-european-cv-group-trigger' => 'europeancv-driving-license']])->add('drivingLicenses', DrivingLicenseType::class, ['entry_type' => EuropeanCVDrivingLicenseType::class, 'label' => false, 'by_reference' => false, 'entry_options' => ['label' => false], 'required' => false])->add('additionalInformations', CollectionType::class, ['entry_type' => EuropeanCVAdditionalInformationType::class, 'entry_options' => ['label' => false], 'by_reference' => false, 'label' => false, 'prototype' => true, 'allow_add' => true, 'allow_delete' => true, 'delete_empty' => true, 'attr' => [
        ...
        ]])->add('attachmentList', null, ['label' => 'Zoznam príloh životopisu', 'attr' => ['placeholder' => 'Napr. kópia inžinierskeho diplomu, potvrdenie o zamestnaní.']])->add('attachments', CollectionType::class, ['entry_type' => EuropeanCVAttachmentType::class, 'entry_options' => ['label' => false], 'by_reference' => false, 'label' => false, 'prototype' => true, 'allow_add' => true, 'allow_delete' => true, 'delete_empty' => true, 'attr' => [
        ...
        ]])->add('practices', CollectionType::class, ['entry_type' => EuropeanCVPracticeType::class, 'entry_options' => ['label' => false], 'by_reference' => false, 'label' => false, 'prototype' => true, 'allow_add' => true, 'allow_delete' => true, 'delete_empty' => true, 'attr' => [
        ...
        ]])->add('educations', CollectionType::class, ['entry_type' => EuropeanCVEducationType::class, 'entry_options' => ['label' => false], 'by_reference' => false, 'label' => false, 'prototype' => true, 'allow_add' => true, 'allow_delete' => true, 'delete_empty' => true, 'attr' => [
        ...
        ]])->add('invertPositionPracticeEducation', CheckboxType::class, ['label' => 'Položku Vzdelávanie a príprava uviesť pred položkou Prax', 'required' => false])->add('languages', CollectionType::class, ['entry_type' => EuropeanCVLanguageType::class, 'entry_options' => ['label' => false], 'by_reference' => false, 'label' => false, 'prototype' => true, 'allow_add' => true, 'allow_delete' => true, 'delete_empty' => true, 'attr' => [
        ...
        ]])->add('outputLanguage', ChoiceType::class, ['label' => 'Výstup', 'mapped' => false, 'required' => false, 'placeholder' => false, 'choices'  => array_flip([
            '' => 'Slovensky',
            'en' => 'Anglicky',
            'de' => 'Nemecky'
        ])])->add('outputEmailSender', EmailType::class, ['label' => 'E-mail odosielateľa', 'mapped' => false, 'required' => false, 'constraints' => [new NotBlank(['groups' => ['send_by_email']])], 'attr' => ['placeholder' => 'Prosím, vyplňte', 'data-parsley-group' => '["send_by_email"]', 'data-parsley-required' => true]])->add('outputEmailReceiver', EmailType::class, ['label' => 'E-mail príjemcu', 'mapped' => false, 'required' => false, 'constraints' => [new NotBlank(['groups' => ['send_by_email']])], 'attr' => ['placeholder' => 'Prosím, vyplňte', 'data-parsley-group' => '["send_by_email"]', 'data-parsley-required' => true]])->add('submitEmail', SubmitIconType::class, ['label' => 'Odoslať', 'validation_groups' => ['send_by_email'], 'icon_left' => '<i class="far fa-envelope"></i>', 'attr' => ['data-parsley-trigger-group' => '["default", "send_by_email"]', 'class' => 'btn btn-block btn-secondary']])->add('submitPreview', SubmitIconType::class, ['label' => 'Zobraziť náhľad', 'icon_left' => '<i class="fas fa-search"></i>', 'attr' => ['class' => 'btn btn-block btn-info', 'formtarget' => '_blank']])->add('submitDoc', SubmitIconType::class, ['label' => 'Uložiť ako Word', 'icon_left' => '<i class="far fa-file-word"></i>', 'attr' => ['class' => 'btn btn-block btn-secondary']])->add('submitPdf', SubmitIconType::class, ['label' => 'Uložiť ako PDF', 'icon_left' => '<i class="far fa-file-pdf"></i>', 'attr' => ['class' => 'btn btn-block btn-secondary']]);

        if ($options['is_user_logged_in']) {
            $builder->add('submit', SubmitIconType::class, ['label' => 'Uložiť životopis', 'icon_left' => '<i class="far fa-save"></i>', 'attr' => ['class' => 'btn btn-block btn-primary']]);
        }
        ...
        $builder->addEventListener(FormEvents::PRE_SUBMIT, function (FormEvent $event) {
            ...
            if ($submittedData['personalWebsite']) {
                $personalWebsiteScheme = parse_url((string) $submittedData['personalWebsite'], PHP_URL_SCHEME);
    ...
    {
        $descriptions = ['skillDigitalInformationProcessing' => [EuropeanCV::DIGITAL_SKILL_LEVEL_BASIC => '
                ...
                '], 'skillDigitalCommunication' => [EuropeanCV::DIGITAL_SKILL_LEVEL_BASIC => '
                ...
                '], 'skillDigitalContentCreation' => [EuropeanCV::DIGITAL_SKILL_LEVEL_BASIC => '
                ...
                '], 'skillDigitalSecurity' => [EuropeanCV::DIGITAL_SKILL_LEVEL_BASIC => '
                ...
                '], 'skillDigitalTroubleshooting' => [EuropeanCV::DIGITAL_SKILL_LEVEL_BASIC => '
        ...
        return $descriptions[$parentName] ?? null;
    }
}