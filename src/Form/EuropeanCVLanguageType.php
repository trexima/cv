...
class EuropeanCVLanguageType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('position', HiddenType::class)
            ->add('language', Select2Type::class, [
                'label' => 'Cudzí jazyk',
            ...
            ->add('listeningLevel', Select2Type::class, [
                'label' => 'Počúvanie',
                'placeholder' => 'Prosím, vyberte možnosť',
                'required' => false,
                'choices_description_callback' => $this->getDescriptionFromLanguageLevelOption(...),
                'choices'  => array_flip(EuropeanCVLanguage::LANGUAGE_LEVEL_LIST)
            ])
            ->add('readingLevel', Select2Type::class, [
                'label' => 'Čítanie',
                'placeholder' => 'Prosím, vyberte možnosť',
                'required' => false, 
                'choices_description_callback' => $this->getDescriptionFromLanguageLevelOption(...),
            ...
            ->add('talkingLevel', Select2Type::class, [
            ...
            ->add('oralSpeechLevel', Select2Type::class, [
            ...
            ->add('writingLevel', Select2Type::class, [
                'label' => 'Písanie',
                'placeholder' => 'Prosím, vyberte možnosť',
                'required' => false,
                'choices_description_callback' => $this->getDescriptionFromLanguageLevelOption(...),
