...
class EuropeanCVPartXType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $now = new \DateTime();
                ...
                ->add('skillDigitalInformationProcessing', Select2Type::class, [
                    'label' => 'Spracovanie informácií',
                    'required' => false,
                    'placeholder' => 'Prosím, vyberte možnosť',
                    'choices_description_callback' => $this->getDescriptionFromSkillDigitalLevelOption(...),
                    'choices'  => array_flip(EuropeanCV::DIGITAL_SKILL_LEVEL_LIST)
                ])
                ->add('skillDigitalCommunication', Select2Type::class, [
                    'label' => 'Komunikácia',
                    'required' => false,
                    'placeholder' => 'Prosím, vyberte možnosť',
                    'choices_description_callback' => $this->getDescriptionFromSkillDigitalLevelOption(...),
                ...
                ->add('skillDigitalContentCreation', Select2Type::class, [
                ...
                ->add('skillDigitalSecurity', Select2Type::class, [
                    'label' => 'Bezpečnosť',
                    'required' => false,
                    'placeholder' => 'Prosím, vyberte možnosť',
                    'choices_description_callback' => $this->getDescriptionFromSkillDigitalLevelOption(...),
                ...
                ->add('skillDigitalTroubleshooting', Select2Type::class, [
                ...
                ->add('additionalInformations', CollectionType::class, [
                ...
                ->add('invertPositionPracticeEducation', CheckboxType::class, [
                ...
                ->add('outputLanguage', ChoiceType::class, [
                    'label' => 'Výstup',
                    'mapped' => false,
                    'required' => false,
                    'placeholder' => false,
                ...
                ->add('outputEmailSender', EmailType::class, [
                    'label' => 'E-mail odosielateľa',
                    'mapped' => false,
                    'required' => false,
                    'constraints' => [
                        new NotBlank(['groups' => ['send_by_email']])
                    ],
                    'attr' => [
                        'placeholder' => 'Prosím, vyplňte',
                ...
                ->add('outputEmailReceiver', EmailType::class, [
                ...
                ->add('submitEmail', SubmitIconType::class, [
                    'label' => 'Odoslať',
                    'validation_groups' => ['send_by_email'],
                ...
                ->add('submitPreview', SubmitIconType::class, [
                ...
                ->add('submitDoc', SubmitIconType::class, [
                ...
                ->add('submitPdf', SubmitIconType::class, [
    ...
    {
        $descriptions = [
            'skillDigitalInformationProcessing' => [
