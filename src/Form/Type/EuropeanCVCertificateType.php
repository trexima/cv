            ...
            ->add('yearRange', YearRangeType::class, array_merge([
                ...
                'field_options' => [
                    ...
                    'endYear' => [
                        ...
                        'choices' => [t('trexima_european_cv.form_label.certificate_no_end_date', [], 'trexima_european_cv')->trans($this->translator) => null] + array_reverse(array_combine(range(date('Y')-100, date('Y')), range(date('Y')-100, date('Y'))), true),
                        'attr' => [
